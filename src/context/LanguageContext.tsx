...
export const translations = {
  fr: {
    ...
    entreprise: {
      introText: 'Nous sommes une entreprise locale engagée à produire des chips et du sésame de première qualité. Notre équipe sélectionne des ingrédients premium et assure une distribution fiable.',
      feature1Title: 'Qualité locale',
      feature1Desc: 'Ingrédients sélectionnés avec soin pour un goût authentique.',
      feature2Title: 'Expertise artisanale',
      feature2Desc: 'Un savoir-faire traditionnel adapté à une production moderne.',
      feature3Title: 'Livraison fiable',
      feature3Desc: 'Nos distributeurs assurent une arrivée rapide et sécurisée.',
    },
    distributeurs: {
    ...
    whyChooseUs: {
      ...
      item1Desc: 'Nos snacks sont préparés avec des ingrédients soigneusement sélectionnés afin de garantir un goût authentique et une qualité exceptionnelle.',
  ...
  en: {
    ...
    entreprise: {
      introText: 'We are a local company committed to producing high quality chips and sesame. Our team selects premium ingredients and ensures reliable distribution.',
      feature1Title: 'Local quality',
      feature1Desc: 'Carefully selected ingredients for authentic taste.',
      feature2Title: 'Artisanal expertise',
      feature2Desc: 'Traditional know-how adapted to modern production.',
      feature3Title: 'Reliable delivery',
      feature3Desc: 'Our distributors ensure fast and secure arrival.',
    },
    distributeurs: {
    ...
    whyChooseUs: {
      ...
      mainTitle: 'Quality at the heart of each of our products',
      mainDesc: 'At BIKOAN SARL, we put our expertise at the service of manufacturing delicious, healthy and quality snacks to offer a unique experience to each of our consumers.',
      item1Title: 'Natural Products',
      item1Desc: 'Our snacks are prepared with carefully selected ingredients to ensure authentic taste and exceptional quality.',
      item2Title: 'Guaranteed Quality',
      item2Desc: 'Each product undergoes rigorous quality control before being released to market.',
      ...
      item4Desc: 'Our experience in food processing allows us to offer products appreciated for their flavor and quality.',
    },
  },
}
