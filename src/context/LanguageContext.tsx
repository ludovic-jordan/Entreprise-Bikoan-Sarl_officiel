...
export const translations = {
  fr: {
    ...
    home: {
      ...
      distributorsText: "Notre réseau de distributeurs garantit une couverture étendue pour la livraison de nos produits.",
      ...
      preparationText: "Apprenez comment nos produits sont préparés, du champ à l’assiette.",
      whyChooseTitle: 'Pourquoi nous choisir ?',
      localisationTitle: 'Plan de localisation',
      viewMore: 'Voir plus',
  ...
  en: {
    ...
    home: {
      ...
      distributorsText: 'Our distributor network ensures broad coverage for product delivery.',
      entrepriseTitle: 'Company presentation',
      entrepriseText: 'A quick overview of our mission, values and commitment to quality.',
      preparationTitle: 'Preparation',
      preparationText: 'Learn how our products are prepared, from field to plate.',
      whyChooseTitle: 'Why choose us?',
      localisationTitle: 'Location map',
      viewMore: 'See more',
